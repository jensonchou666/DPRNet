...
model_name = 'd2x_pvtb1_fpnM'
backbone_name = 'pvt_v2_b1'
ckpt_path = 'pretrain/pvt_v2_b1.pth'
decoder_args = fpn_decoder_args_M

# pretrained_x4D_path = 'work_dir/GID_Water_3d5K/d4x_pvtb1_fpnM-e40/ckpt/epoch=6@val_mIoU=89.38@d4x_pvtb1_fpnM-GID_Water_3d5K.ckpt'
...
def get_network(cfg):
    ...
    D1 = torch.load(pretrained_d4x_path)['state_dict']
