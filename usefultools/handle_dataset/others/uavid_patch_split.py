...
def parse_args():
    ...
    parser.add_argument("--output-img-dir", default="data/uavid/test/images")
    parser.add_argument("--output-mask-dir", default="data/uavid/test/masks")
