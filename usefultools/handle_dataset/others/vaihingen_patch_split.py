...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/vaihingen/test_images")
    parser.add_argument("--mask-dir", default="data/vaihingen/test_masks")
    parser.add_argument("--output-img-dir", default="data/vaihingen/test-512/images")
    parser.add_argument("--output-mask-dir", default="data/vaihingen/test-512/masks")
